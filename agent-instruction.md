...
- The AI agent should maintain a `agent-log.md` and `agent-log-brief.md`. After each execution, the agent should write done briefly what it has done in the log. The newest update is put at the beginning of the log.
